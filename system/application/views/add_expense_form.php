<?php
		...
		$attributes = array('id' => 'add_expense_to_projects', 'class' => 'add_expense_to_projects');
...
?>
        ...
        <table width="640" height="450" border="2" cellpadding="1" onmouseover="<?php echo "Enter Expense Details";?>" bordercolor="#CC6600" bgcolor="#FFFFCC">
         <tr>
         ...
         <th align="center" width="160">Date of Expenditure(YYYY-MM-DD) </th>
         </tr>
         <tr>
        ...
        <br />
         ...
         <input type="submit" name="add_more_btn" value="Add More" align="middle" onclick="add_expense_more_form"/>
