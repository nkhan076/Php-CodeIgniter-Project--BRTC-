...
?>
        <table width="540" height="350" border="2" onmouseover="<?php echo "Enter Expense Details";?>" bordercolor="#CC6600" bgcolor="#FFFFCC" bordercolordark="#000066">
         ...
         <td align="center"><input type="text" name="fund_name6" /></td>
         <td align="center"><input type="text" name="client_id6" /></td>
         <td align="center"><input type="text" name="fund_amount6" /></td>  
         <td align="center"><input type="text" name="date6" /></td> 
         </tr>
         <tr>
         <td align="center">7.</td>
         <td align="center"><input type="text" name="fund_name7" /></td>
         <td align="center"><input type="text" name="client_id7" /></td>
         <td align="center"><input type="text" name="fund_amount7" /></td>  
         <td align="center"><input type="text" name="date7" /></td> 
         </tr>
         <tr>
         <td align="center">8.</td>
         <td align="center"><input type="text" name="fund_name8" /></td>
         <td align="center"><input type="text" name="client_id8" /></td>
         <td align="center"><input type="text" name="fund_amount8" /></td>  
         <td align="center"><input type="text" name="date8" /></td> 
         </tr>
         <tr>
         <td align="center">9.</td>
         <td align="center"><input type="text" name="fund_name9" /></td>
         <td align="center"><input type="text" name="client_id9" /></td>
         <td align="center"><input type="text" name="fund_amount9" /></td>  
         <td align="center"><input type="text" name="date9" /></td> 
         </tr>
         <tr>
         <td align="center">10.</td>
         <td align="center"><input type="text" name="fund_name10" /></td>
         <td align="center"><input type="text" name="client_id10" /></td>
         <td align="center"><input type="text" name="fund_amount10" /></td>  
         <td align="center"><input type="text" name="date10" /></td> 
         </tr>
        </table>
        <br />
